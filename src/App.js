...
export default function App() {
  ...
  return (
      <Routes>
        ...
        <Route exact path="/" element={<ProtectedRoute><Sidebar user={user} isUserLoaded={isUserLoaded} groups={groups} isGroupsLoaded={isGroupsLoaded} /><Home user={user} /></ProtectedRoute>} />
        <Route exact path="/group/:id" element={<ProtectedRoute><Sidebar user={user} isUserLoaded={isUserLoaded} groups={groups} isGroupsLoaded={isGroupsLoaded} /><Group groups={groups} isGroupsLoaded={isGroupsLoaded}/></ProtectedRoute>} />
        <Route exact path="/settings" element={<ProtectedRoute><Sidebar user={user} isUserLoaded={isUserLoaded} groups={groups} isGroupsLoaded={isGroupsLoaded} /><Settings /></ProtectedRoute>} />
