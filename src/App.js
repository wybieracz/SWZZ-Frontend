...
export default function App() {
  ...
  return (
      <Routes>
        ...
        <Route exact path="/" element={<ProtectedRoute><Sidebar username={username} groups={groups} isGroupsLoaded={isGroupsLoaded} /><Home username={username} /></ProtectedRoute>} />
        <Route exact path="/group/:id" element={<ProtectedRoute><Sidebar username={username} groups={groups} isGroupsLoaded={isGroupsLoaded} /><Group groups={groups} isGroupsLoaded={isGroupsLoaded}/></ProtectedRoute>} />
        <Route exact path="/settings" element={<ProtectedRoute><Sidebar username={username} groups={groups} isGroupsLoaded={isGroupsLoaded} /><Settings /></ProtectedRoute>} />
